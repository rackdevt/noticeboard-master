...
function groups_action_create_group() {
	...
	if ( isset( $_POST['save'] ) ) {
		...
		setcookie( 'bp_new_group_id', $bp->groups->new_group_id, time()+60*3, COOKIEPATH );
		setcookie( 'bp_completed_create_steps', serialize( $bp->groups->completed_create_steps ), time()+60*3, COOKIEPATH );
