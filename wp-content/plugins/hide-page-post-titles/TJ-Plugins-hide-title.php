<?php
/*
Plugin Name: Hide Page & Post Titles 
Plugin URI: http://tjplugins.com
Description: Allows authors to hide the page & post title.
Version: 01
Author: TJ Plugins
Author URI: http://tjplugins.com
*/
 
if ( !class_exists( 'TJPluginsHideTitle' ) ) {
	
    class TJPluginsHideTitle {
        
    	private $slug = 'hidepagetitles_toggle_title';
        ...
        */
        function TJPluginsHideTitle(){ $this->__construct(); }
...
<!-- END TJ Plugins Hide Page Title -->
    ...
    $TJPluginsHideTitle = new TJPluginsHideTitle();
    
} // !class_exists( 'TJPluginsHideTitle' )
