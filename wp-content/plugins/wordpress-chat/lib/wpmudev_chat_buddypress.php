...
function wpmudev_chat_buddypress_friends_list() {
	...
	//echo "members_template<pre>"; print_r($members_template); echo "</pre>";
	//echo "members_template->member<pre>"; print_r($members_template->member); echo "</pre>";
	//echo "members_template->member->ID[". $members_template->member-> ."]<br />";
