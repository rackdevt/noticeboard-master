...
$search = ( ! empty( $_GET['r'] ) ) ? $_GET['r'] : false;
$paged = ( get_query_var('paged') ) ? get_query_var('paged') : 1;

$wp_query = null;
$wp_query = new WP_Query( array( 'post_type' => 'location', 'posts_per_page' => 12, 'paged' => $paged, 's' => $search ) );
...
get_header() ?>
	...
	<div id="content">
		<div class="padder">
			...
			<div id="location-dir-search" class="dir-search no-ajax">
			...
			<div class="item-list-tabs no-ajax">
				<ul>
                	...
                	<li class="selected"><a href="<?php echo bp_get_root_domain() .'/locations/' ?>"><?php _e( 'All Locations', 'mapo' ) ?></a></li>
                	<?php foreach( (array)$categories as $category ) : ?>
                	<li><a href="<?php echo bp_get_root_domain() .'/continents/'. $category->slug .'/' ?>"><?php echo $category->name ?></a></li>
                    <?php endforeach; ?>
				</ul>
            </div>
