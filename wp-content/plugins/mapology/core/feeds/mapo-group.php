...
<rss version="2.0"
	...
	<?php do_action( 'mapo_group_events_feed' ); ?>
>

<channel>
	<title><?php echo bp_site_name() ?> | <?php echo $bp->groups->current_group->name ?> | <?php _e( 'Latest Routes', 'mapo' ) ?></title>
	<atom:link href="<?php self_link(); ?>" rel="self" type="application/rss+xml" />
	<link><?php mapo_group_routes_feed_link() ?></link>
	<description><?php printf( __( '%s - Latest Routes Feed', 'mapo' ), $bp->groups->current_group->name  ) ?></description>
	<pubDate><?php echo mysql2date( 'D, d M Y H:i:s O', mapo_group_get_last_published(), false ); ?></pubDate>
	...
	<?php do_action( 'mapo_group_feed_head' ); ?>
		...
		<?php while ( mapo_routes() ) : mapo_the_route(); ?>
			<item>
				...
				if( count( $waypoints ) >= 2 ) : ?>
                    ...
                    <?php endforeach; ?>
                <?php endif; ?>
				<?php do_action( 'mapo_group_feed_item' ); ?>
			</item>
		<?php endwhile; ?>
	<?php endif; ?>
</channel>
