...
<rss version="2.0"
	...
	<?php do_action( 'mapo_global_routes_feed' ); ?>
>

<channel>
	<title><?php echo bp_site_name() ?> | <?php _e( 'Latest Sitewide Routes', 'mapo' ) ?></title>
	<atom:link href="<?php self_link(); ?>" rel="self" type="application/rss+xml" />
	<link><?php mapo_sitewide_routes_feed_link() ?></link>
	<description><?php printf( __( '%s - Latest Sitewide Routes Feed', 'mapo' ), bp_site_name()  ) ?></description>
	<pubDate><?php echo mysql2date( 'D, d M Y H:i:s O', mapo_get_last_published(), false ); ?></pubDate>
		...
		<?php while ( mapo_routes() ) : mapo_the_route(); ?>
			<item>
				...
				if( count( $waypoints ) >= 2 ) : ?>
                    ...
                    <?php endforeach; ?>
                <?php endif; ?>
				<?php do_action( 'mapo_global_feed_item' ); ?>
			</item>
		<?php endwhile; ?>
	<?php endif; ?>
</channel>
