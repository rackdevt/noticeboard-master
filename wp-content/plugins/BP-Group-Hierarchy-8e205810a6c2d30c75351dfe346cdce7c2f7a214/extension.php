...
class BP_Groups_Hierarchy_Extension extends BP_Group_Extension {
	...
	function create_screen( $group_id = null ) {
		...
		$site_root->id = 0;
		$site_root->name = __( 'All GNB Groups', 'bp-group-hierarchy' );
		...
		<p style="color:blue;"><br />By default, all newly created main groups belong to '<b>All GNB Groups</b>.'<br />
		If this group is a sub-group to another group, please select the parent group from the drop-down list above;<br />
		otherwise click 'Next Step' button below.
		</p>
