		...
		<div class="inside">
			...
			<table class="form-table">
				<tr>
					...
					<td>
						<code><strong>[cf_list_categories style="grid | list"]</strong></code>
				...
				<tr>
					...
					<td>
						<code><strong>[cf_classifieds_btn text="<?php _e('Classifieds', $this->text_domain);?>" view="loggedin | loggedout | always"]</strong></code> or
						<br /><code><strong>[cf_classifieds_btn view="loggedin | loggedout | always"]&lt;img src="<?php _e('someimage.jpg', $this->text_domain); ?>" /&gt;<?php _e('Classifieds', $this->text_domain);?>[/cf_classifieds_btn]</strong></code>
				...
				<tr>
					...
					<td>
						<code><strong>[cf_my_classifieds_btn text="<?php _e('My Classifieds', $this->text_domain);?>" view="loggedin | loggedout | always"]</strong></code> or
						<br /><code><strong>[cf_my_classifieds_btn view="loggedin | loggedout | always"]&lt;img src="<?php _e('someimage.jpg', $this->text_domain); ?>" /&gt;<?php _e('My Classifieds', $this->text_domain);?>[/cf_my_classifieds_btn]</strong></code>
				...
				<tr>
					...
					<td>
						<code><strong>[cf_my_credits_btn text="<?php _e('My Classified Credits', $this->text_domain);?>" view="loggedin | loggedout | always"]</strong></code> or
						<br /><code><strong>[cf_my_credits_btn view="loggedin | loggedout | always"]&lt;img src="<?php _e('someimage.jpg', $this->text_domain); ?>" /&gt;<?php _e('Edit Classified', $this->text_domain);?>[/cf_my_credits_btn]</strong></code>
				...
				<tr>
					...
					<td>
						<code><strong>[cf_add_classified_btn text="<?php _e('Add Classified', $this->text_domain);?>" view="loggedin | loggedout | always"]</strong></code> or
						<br /><code><strong>[cf_add_classified_btn view="loggedin | loggedout | always"]&lt;img src="<?php _e('someimage.jpg', $this->text_domain); ?>" /&gt;<?php _e('Add Classified', $this->text_domain);?>[/cf_add_classified_btn]</strong></code>
				...
				<tr>
					...
					<td>
						<code><strong>[cf_profile_btn text="<?php _e('Go to Profile', $this->text_domain);?>" view="loggedin | loggedout | always"]</strong></code> or
						<br /><code><strong>[cf_profile_btn view="loggedin | loggedout | always"]&lt;img src="<?php _e('someimage.jpg', $this->text_domain); ?>" /&gt;<?php _e('Go to Profile', $this->text_domain);?>[/cf_profile_btn]</strong></code>
				...
				<tr>
					...
					<td>
						<code><strong>[cf_signin_btn text="<?php _e('Signin', $this->text_domain);?>" view="loggedin | loggedout | always"]</strong></code> or
						<br /><code><strong>[cf_signin_btn view="loggedin | loggedout | always"]&lt;img src="<?php _e('someimage.jpg', $this->text_domain); ?>" /&gt;<?php _e('Signin', $this->text_domain);?>[/cf_signin_btn]</strong></code>
				...
				<tr>
					...
					<td>
						<code><strong>[cf_logout_btn text="<?php _e('Logout', $this->text_domain);?>"  view="loggedin | loggedout | always" redirect="http://someurl"]</strong></code> or
