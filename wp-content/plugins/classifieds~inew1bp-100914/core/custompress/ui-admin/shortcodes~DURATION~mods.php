			...
			<table class="form-table">
				<tr>
					...
					<td>
						...
						<div class="embed-code-wrap">
							...
							<code>[custom_fields_input post_id="post_id"] ct_Duration_text_bb2f, _ct_text_4cfeb3eac6f1f,... [/custom_fields_input]</code>
							...
							<code>[custom_fields_input post_id="post_id"] [ct_filter terms="cat1, cat2,.."] ct_Duration_text_bb2f, _ct_text_4cfeb3eac6f1f,... [/ct_filter] [/custom_fields_input]</code>
							...
							<code>[ct_in id="ct_Duration_text_bb2f" property="title | description | input"]</code>
					...
					<td>
						<div>
							...
							<div class="embed-code-wrap">
								...
								<br /><br /><?php _e('or with field list', $this->text_domain); ?><br />
								<code>[custom_fields_block] ct_Duration_text_bb2f, _ct_text_4cfeb3eac6f1f,... [/custom_fields_block]</code>
								<br /><span class="description"><?php _e('Returns a set of input fields as supplied by the field id list in the shortcode. Any ids not associate with the post type will be ignored.', $this->text_domain); ?></span>

								<br /><br /><?php _e('or with field list filtered by category', $this->text_domain);?>
								<br /><code>[custom_fields_block] [ct_filter terms="cat1, cat2,.."] ct_Duration_text_bb2f, _ct_text_4cfeb3eac6f1f,... [/ct_filter] [/custom_fields_block]</code>
								<br /><span class="description"><?php _e('Multiple filters may be used in one input block.', $this->text_domain); ?></span>
							</div>
							<p>
				...
				<tr>
					...
					<td>
						...
						<code>[ct_filter terms="cat1, cat2,.." not="true | false"] ct_Duration_text_bb2f, _ct_text_4cfeb3eac6f1f,... [/ct_filter]</code>
